...
var $author$project$Main$initState = {
	aliveCells: $elm$core$Set$empty,
	playerSelection: $author$project$Main$Completed(
		_Utils_Tuple2(
			_Utils_Tuple2(1, 1),
			_Utils_Tuple2(4, 8))),
	turnState: $author$project$Main$Idle
};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			boardSize: $author$project$Main$defaultBoardSize,
			gameType: $author$project$Main$VsBot($author$project$Main$Random),
			state: $mdgriffith$elm_animator$Animator$init($author$project$Main$initState),
			turnCount: 0
		},
		A2(
			$elm$random$Random$generate,
		...
		if (key.$ === 'Control') {
				...
				case 'ArrowUp':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Up, selectionCorner: $author$project$Main$BottomRight}));
				case 'ArrowDown':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Down, selectionCorner: $author$project$Main$BottomRight}));
				case 'ArrowLeft':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Left, selectionCorner: $author$project$Main$BottomRight}));
				case 'ArrowRight':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Right, selectionCorner: $author$project$Main$BottomRight}));
				default:
					break _v0$14;
			}
		} else {
			switch (key.a.valueOf()) {
				case 'w':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Up, selectionCorner: $author$project$Main$LeftTop}));
				case 's':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Down, selectionCorner: $author$project$Main$LeftTop}));
				case 'a':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Left, selectionCorner: $author$project$Main$LeftTop}));
				case 'd':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Right, selectionCorner: $author$project$Main$LeftTop}));
				case 'k':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{direction: $author$project$Main$Up, selectionCorner: $author$project$Main$BottomRight}));
...
var $author$project$Main$moveSelection = F3(
	function (boardSize, selection, _v0) {
		var selectionCorner = _v0.selectionCorner;
...
var $author$project$Main$unwrapInteractiveSelection = function (interactiveSelection) {
	if (interactiveSelection.$ === 'Partial') {
		...
		var lastHovered = interactiveSelection.a.lastHovered;
		...
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							state: A3(
								...
								{aliveCells: aliveCells, playerSelection: currentState.playerSelection, turnState: $author$project$Main$Idle},
								model.state)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ProcessControl':
				var maybeControl = msg.a;
				if (maybeControl.$ === 'Just') {
						...
						case 'Move':
							...
							var playerSelection = $author$project$Main$Completed(
								A3(
									...
									model.boardSize,
									$author$project$Main$unwrapInteractiveSelection(currentState.playerSelection),
									control));
							return _Utils_Tuple2(
								_Utils_update(
									model,
			...
			case 'UpdateSelection':
				...
				var playerSelection = function () {
					var _v4 = currentState.playerSelection;
					if (_v4.$ === 'Partial') {
						var start = _v4.a.start;
						return $author$project$Main$Partial(
							{lastHovered: cell, start: start});
					} else {
						return currentState.playerSelection;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'EndSelection':
				var playerSelection = function () {
					var _v5 = currentState.playerSelection;
					if (_v5.$ === 'Partial') {
						var start = _v5.a.start;
						var lastHovered = _v5.a.lastHovered;
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: A2($mdgriffith$elm_animator$Animator$queue, steps, model.state),
...
var $author$project$Main$EndPlayerTurn = {$: 'EndPlayerTurn'};
var $author$project$Main$EndSelection = {$: 'EndSelection'};
...
var $author$project$Main$dracula = {
	background: A3($mdgriffith$elm_ui$Element$rgb255, 40, 42, 54),
	comment: A3($mdgriffith$elm_ui$Element$rgb255, 98, 114, 164),
	currentLine: A3($mdgriffith$elm_ui$Element$rgb255, 68, 71, 90),
	cyan: A3($mdgriffith$elm_ui$Element$rgb255, 139, 233, 253),
	foreground: A3($mdgriffith$elm_ui$Element$rgb255, 248, 248, 242),
	green: A3($mdgriffith$elm_ui$Element$rgb255, 80, 250, 123),
	...
	var resetButton = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$dracula.background),
				$mdgriffith$elm_ui$Element$Border$color($author$project$Main$dracula.comment),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Main$dracula.comment),
				$mdgriffith$elm_ui$Element$Border$width(2),
	...
	var root = $mdgriffith$elm_ui$Element$el(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$color($author$project$Main$dracula.foreground),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					textFromInt(
						A2($author$project$Main$playerScore, model.boardSize, currentAliveCells))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.AliveCells":{"args":[],"type":"Set.Set Main.Cell"},"Main.Cell":{"args":[],"type":"( Basics.Int, Basics.Int )"},"Main.Selection":{"args":[],"type":"( Main.Cell, Main.Cell )"},"Main.MoveSelection":{"args":[],"type":"{ selectionCorner : Main.SelectionCorner, direction : Main.Direction }"}},"unions":{"Main.Msg":{"args":[],"tags":{"None":[],"Reset":[],"Tick":["Time.Posix"],"SetAliveCells":["Main.AliveCells"],"EndPlayerTurn":[],"StartSelection":["Main.Cell"],"UpdateSelection":["Main.Cell"],"EndSelection":[],"EnemyTurn":["Main.Selection"],"ProcessControl":["Maybe.Maybe Main.Control"]}},"Main.Control":{"args":[],"tags":{"Move":["Main.MoveSelection"],"EndTurn":[],"ControlReset":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Set.Set":{"args":["t"],"tags":{"Set_elm_builtin":["Dict.Dict t ()"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Main.Direction":{"args":[],"tags":{"Up":[],"Right":[],"Down":[],"Left":[]}},"Main.SelectionCorner":{"args":[],"tags":{"LeftTop":[],"BottomRight":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});
...
},{"./src/Main.elm":"src/Main.elm"}],"../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
