...
var $author$project$Main$entireSelection = _Utils_Tuple2(
	_Utils_Tuple2(0, 0),
	_Utils_Tuple2($author$project$Main$defaultBoardSize, $author$project$Main$defaultBoardSize));
...
var $author$project$Main$Board = F2(
	function (size, aliveCells) {
		return {aliveCells: aliveCells, size: size};
	});
...
var $author$project$Main$gliderBoard = A2(
	$author$project$Main$Board,
	$author$project$Main$defaultBoardSize,
...
var $author$project$Main$mirrorLeftHalf = function (board) {
	var rightPart = A2(
		$elm$core$Set$map,
		function (c) {
			return _Utils_Tuple2((board.size - 1) - c.a, (board.size - 1) - c.b);
		},
		board.aliveCells);
	return _Utils_update(
		board,
		{
			aliveCells: A2($elm$core$Set$union, board.aliveCells, rightPart)
		});
};
var $author$project$Main$initBoard = $author$project$Main$mirrorLeftHalf($author$project$Main$gliderBoard);
...
var $author$project$Main$randomSymmetricBoard = A2(
	$elm$random$Random$map,
	function (cells) {
		return $author$project$Main$mirrorLeftHalf(
			{aliveCells: cells, size: $author$project$Main$defaultBoardSize});
	},
	$author$project$Main$randomCells);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			board: $author$project$Main$initBoard,
			enemySelection: $author$project$Main$entireSelection,
		...
		A2($elm$random$Random$generate, $author$project$Main$SetBoard, $author$project$Main$randomSymmetricBoard));
};
	...
	if (key.$ === 'Control') {
			...
			case 'ArrowUp':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Up, selectionCorner: $author$project$Main$End}));
			case 'ArrowDown':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Down, selectionCorner: $author$project$Main$End}));
			case 'ArrowLeft':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Left, selectionCorner: $author$project$Main$End}));
			case 'ArrowRight':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Right, selectionCorner: $author$project$Main$End}));
			default:
				return $elm$core$Maybe$Nothing;
		}
	} else {
		switch (key.a.valueOf()) {
			case 'w':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Up, selectionCorner: $author$project$Main$Start}));
			case 's':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Down, selectionCorner: $author$project$Main$Start}));
			case 'a':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Left, selectionCorner: $author$project$Main$Start}));
			case 'd':
				return $elm$core$Maybe$Just(
					$author$project$Main$Move(
						{direction: $author$project$Main$Right, selectionCorner: $author$project$Main$Start}));
			default:
				return $elm$core$Maybe$Nothing;
		}
	}
...
var $author$project$Main$moveSelection = F2(
	function (selection, _v0) {
		...
		var _v1 = function () {
			if (selectionCorner.$ === 'Start') {
				return _Utils_Tuple2(selection.b, selection.a);
			} else {
				return selection;
			}
		}();
		...
		var newCell = A3(
			...
			$elm$core$Basics$add(delta.a),
			$elm$core$Basics$add(delta.b),
			cell);
		...
		var permutations = $elm$core$Set$fromList(
			A2(
				...
				A2(
					...
					_List_fromArray(
						[-1, 0, 1]))));
		var onGrid = function (c) {
			return (c.a >= 0) && ((_Utils_cmp(c.a, boardSize) < 0) && ((c.b >= 0) && (_Utils_cmp(c.b, boardSize) < 0)));
		};
		var cells = A2(
			$elm$core$Set$filter,
			onGrid,
...
var $author$project$Main$nextBoard = F3(
	function (board, selection1, selection2) {
		var processCell = function (_v1) {
			var cell = _v1.a;
			var aliveNeighbours = _v1.b;
			var inSelection2 = A2($author$project$Main$cellInSelection, selection2, cell);
			var inSelection1 = A2($author$project$Main$cellInSelection, selection1, cell);
			var alive = A2($elm$core$Set$member, cell, board.aliveCells);
			var active = inSelection1 !== inSelection2;
			if (active) {
				...
				if (A2($elm$core$Set$member, cell, board.aliveCells)) {
					return $elm$core$Maybe$Just(cell);
				} else {
					return $elm$core$Maybe$Nothing;
				}
		...
		var cells = $elm$core$Set$fromList(
			A2(
				$elm$core$List$filterMap,
				processCell,
				A2(
					...
					$elm_community$list_extra$List$Extra$gatherEquals(
						A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Main$neighbours(board.size),
								$elm$core$Set$toList),
							$elm$core$Set$toList(board.aliveCells))))));
		return _Utils_update(
			board,
			{aliveCells: cells});
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
								...
								model,
								{
									playerSelection: $author$project$Main$Completed(
										A2(
											...
											$author$project$Main$unwrapInteractiveSelection(model.playerSelection),
											control))
								});
						} else {
							return model;
			...
			case 'StartSelection':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							playerSelection: $author$project$Main$Partial(
			...
			case 'EndSelection':
				var playerSelection = function () {
					var _v3 = model.playerSelection;
					if (_v3.$ === 'Partial') {
						var start = _v3.a.start;
						var lastHovered = _v3.a.lastHovered;
			...
			case 'EndPlayerTurn':
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$Main$randomSelection(model.board.size)));
			default:
...
var $author$project$Main$leftScore = function (board) {
	return $elm$core$Set$size(
		A2(
			$elm$core$Set$filter,
			function (c) {
				return _Utils_cmp(c.a, (board.size / 2) | 0) < 0;
			},
			board.aliveCells));
};
...
var $author$project$Main$rightScore = function (board) {
	return $elm$core$Set$size(
		A2(
			$elm$core$Set$filter,
			function (c) {
				return _Utils_cmp(c.a, (board.size / 2) | 0) > -1;
			},
			board.aliveCells));
};
...
var $author$project$Main$viewBoard = F2(
	function (model, board) {
			...
			function (boardSize, player, selection) {
				var color = function () {
					if (player.$ === 'Player') {
						...
						return $author$project$Main$dracula.comment;
					}
				}();
				var _v1 = $author$project$Main$sortSelection(selection);
				var _v2 = _v1.a;
		...
		var playerSelection = $author$project$Main$unwrapInteractiveSelection(model.playerSelection);
		var nextStepBoard = A3(
			$author$project$Main$nextBoard,
			board,
			_Utils_Tuple2(
				_Utils_Tuple2(-1, -1),
				_Utils_Tuple2(-1, -1)),
			$author$project$Main$entireSelection);
		var viewCell = function (cell) {
			var nextAlive = A2($elm$core$Set$member, cell, nextStepBoard.aliveCells);
			...
			var aliveColor = inSelection ? $author$project$Main$dracula.foreground : $author$project$Main$dracula.comment;
			var alive = A2($elm$core$Set$member, cell, board.aliveCells);
			var attributes = alive ? _List_fromArray(
				[
			...
			var nextStateAttribues = function () {
				var _v0 = _Utils_Tuple2(alive, nextAlive);
				_v0$2:
				while (true) {
					if (_v0.a) {
						if (!_v0.b) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$StartSelection(cell)),
						$mdgriffith$elm_ui$Element$Events$onMouseEnter(
						$author$project$Main$UpdateSelection(cell))
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
					$elm$core$List$concat(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A3(viewSelection, board.size, $author$project$Main$Player, playerSelection)),
						$mdgriffith$elm_ui$Element$behindContent(
						A3(viewSelection, board.size, $author$project$Main$Enemy, model.enemySelection))
					]),
				A2($elm_community$list_extra$List$Extra$initialize, board.size, viewRow)));
	});
var $author$project$Main$layout = function (model) {
			...
			[
				...
				$mdgriffith$elm_ui$Element$text(
					$elm$core$Debug$toString(
						$author$project$Main$leftScore(model.board)))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$text(
					$elm$core$Debug$toString(model.turnCount))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$text(
					$elm$core$Debug$toString(
						$author$project$Main$rightScore(model.board))))
			]));
	var root = $mdgriffith$elm_ui$Element$el(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Events$onMouseUp($author$project$Main$EndSelection)
			]));
	var resetButton = A2(
	...
	var board = A2($author$project$Main$viewBoard, model, model.board);
	return root(
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Board":{"args":[],"type":"{ size : Basics.Int, aliveCells : Set.Set Main.Cell }"},"Main.Cell":{"args":[],"type":"( Basics.Int, Basics.Int )"},"Main.Selection":{"args":[],"type":"( Main.Cell, Main.Cell )"},"Main.MoveSelection":{"args":[],"type":"{ selectionCorner : Main.SelectionCorner, direction : Main.Direction }"}},"unions":{"Main.Msg":{"args":[],"tags":{"None":[],"Reset":[],"SetBoard":["Main.Board"],"EndPlayerTurn":[],"StartSelection":["Main.Cell"],"UpdateSelection":["Main.Cell"],"EndSelection":[],"EnemyTurn":["Main.Selection"],"ProcessControl":["Maybe.Maybe Main.Control"]}},"Main.Control":{"args":[],"tags":{"Move":["Main.MoveSelection"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Set.Set":{"args":["t"],"tags":{"Set_elm_builtin":["Dict.Dict t ()"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Main.Direction":{"args":[],"tags":{"Up":[],"Right":[],"Down":[],"Left":[]}},"Main.SelectionCorner":{"args":[],"tags":{"Start":[],"End":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36861" + '/');
