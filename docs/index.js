...
{
	if (region.aQ.aL === region.bN.aL)
	{
		return 'on line ' + region.aQ.aL;
	}
	return 'on lines ' + region.aQ.aL + ' through ' + region.bN.aL;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { du: 'hidden', c8: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { du: 'mozHidden', c8: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { du: 'msHidden', c8: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { du: 'webkitHidden', c8: 'webkitvisibilitychange' }
		: { du: 'hidden', c8: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bR: fragment, bX: host, ce: path, cg: port_, cj: protocol, ck: query};
	});
...
var $author$project$Main$SetAliveCells = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$VsBot = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$defaultBoardSize = 10;
...
var $mdgriffith$elm_animator$Animator$init = function (first) {
	return {
		...
		b_: first,
		aK: _List_Nil,
		b8: $mdgriffith$elm_animator$Internal$Time$absolute(
...
var $author$project$Main$initState = {
	C: $elm$core$Set$empty,
	m: $author$project$Main$Completed(
		_Utils_Tuple2(
			_Utils_Tuple2(1, 1),
			_Utils_Tuple2(4, 8))),
	t: $author$project$Main$Idle
};
...
var $author$project$Main$mirrorLeftHalf = F2(
	function (boardSize, aliveCells) {
		var rightPart = A2(
			$elm$core$Set$map,
			function (c) {
				return _Utils_Tuple2((boardSize - 1) - c.a, (boardSize - 1) - c.b);
			},
			aliveCells);
		return A2($elm$core$Set$union, aliveCells, rightPart);
	});
...
var $author$project$Main$randomCell = function (boardSize) {
	return A2(
		$elm$random$Random$pair,
		A2($elm$random$Random$int, 0, boardSize - 1),
		A2($elm$random$Random$int, 0, boardSize - 1));
};
...
var $author$project$Main$randomCells = A2(
	$elm_community$random_extra$Random$Set$set,
	24,
	$author$project$Main$randomCell($author$project$Main$defaultBoardSize));
var $author$project$Main$randomSymmetricBoard = function (boardSize) {
	return A2(
		$elm$random$Random$map,
		$author$project$Main$mirrorLeftHalf(boardSize),
		$author$project$Main$randomCells);
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			u: $author$project$Main$defaultBoardSize,
			bT: $author$project$Main$VsBot(0),
			b: $mdgriffith$elm_animator$Animator$init($author$project$Main$initState),
			aV: 0
		},
		A2(
			$elm$random$Random$generate,
			$author$project$Main$SetAliveCells,
			$author$project$Main$randomSymmetricBoard($author$project$Main$defaultBoardSize)));
};
var $author$project$Main$ProcessControl = function (a) {
	return {$: 9, a: a};
};
		...
		if (!upcomingOccurring.b) {
			...
			if (!(!personality.dh)) {
				...
				var nextPersonality = getPersonality(
					lookup(next));
				var totalPortions = A2($elm$core$Basics$max, personality.dh + nextPersonality.cU, 1);
...
var $mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious = F5(
	function (lookup, getPersonality, _v0, unmodified, upcomingOccurring) {
		...
		var personality = getPersonality(
			lookup(event));
		var totalPrevPortions = A2($elm$core$Basics$max, prevPersonality.dh + personality.cU, 1);
		var earlyBy = A2($ianmackenzie$elm_units$Quantity$multiplyBy, personality.cU / totalPrevPortions, totalPrevDuration);
		if (!upcomingOccurring.b) {
...
var $mdgriffith$elm_animator$Internal$Timeline$createLookAhead = F4(
	function (fn, lookup, currentEvent, upcomingEvents) {
		if (!upcomingEvents.b) {
			...
			var upcomingOccurring = A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bf, currentEvent, unadjustedUpcoming, remain);
			return $elm$core$Maybe$Just(
				{
					cQ: lookup(
						$mdgriffith$elm_animator$Internal$Timeline$getEvent(upcomingOccurring)),
					d$: $mdgriffith$elm_animator$Internal$Timeline$hasDwell(upcomingOccurring),
					cu: $mdgriffith$elm_animator$Internal$Time$inMilliseconds(
		...
		while (true) {
			...
			var transition = function (newState) {
				if (!futureLines.b) {
					...
					return A2($mdgriffith$elm_animator$Internal$Time$thisBeforeOrEqualThat, futureStart, details.b8) ? A7($mdgriffith$elm_animator$Internal$Timeline$overLines, fn, lookup, details, $elm$core$Maybe$Nothing, future, restOfFuture, newState) : newState;
				}
			};
			var now = function () {
				if (!futureLines.b) {
					...
					var restOfFuture = futureLines.b;
					return A2($mdgriffith$elm_animator$Internal$Time$thisBeforeThat, futureStart, details.b8) ? futureStart : details.b8;
				}
			}();
			var lineStartEv = function () {
				if (maybePreviousEvent.$ === 1) {
					return A4($mdgriffith$elm_animator$Internal$Timeline$adjustTime, lookup, fn.bf, unadjustedStartEvent, lineRemain);
				} else {
					var prev = maybePreviousEvent.a;
					return A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bf, prev, unadjustedStartEvent, lineRemain);
				}
			}();
			if (A2(
				...
				if (A2(
					...
					if (!lineRemain.b) {
						return transition(
							A5(fn.bB, lookup, lineStartEv, now, $elm$core$Maybe$Nothing, state));
					} else {
						var unadjustedNext = lineRemain.a;
						var lineRemain2 = lineRemain.b;
						var next = A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bf, unadjustedStartEvent, unadjustedNext, lineRemain2);
						if (A2(
							$mdgriffith$elm_animator$Internal$Time$thisBeforeThat,
							now,
							...
							if (A2(
								...
								if (!lineRemain2.b) {
									return transition(
										A5(fn.bB, lookup, next, now, $elm$core$Maybe$Nothing, state));
								} else {
									var unadjustedNext2 = lineRemain2.a;
									var lineRemain3 = lineRemain2.b;
									var next2 = A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bf, unadjustedNext, unadjustedNext2, lineRemain3);
									if (A2(
										$mdgriffith$elm_animator$Internal$Time$thisBeforeThat,
										now,
...
var $mdgriffith$elm_animator$Internal$Timeline$foldp = F3(
	function (lookup, fn, _v0) {
		...
		var _v1 = timelineDetails.bP;
		var timetable = _v1;
		var start = fn.aQ(
			lookup(timelineDetails.b_));
		if (!timetable.b) {
			return start;
		} else {
...
var $mdgriffith$elm_animator$Internal$Timeline$linearDefault = {cU: 0, cV: 0, dh: 0, di: 0, eJ: 0};
...
var $mdgriffith$elm_animator$Internal$Timeline$interrupt = F3(
	function (details, startAt, scheduled) {
		var _v0 = details.bP;
		var lines = _v0;
		var _v1 = A5($mdgriffith$elm_animator$Internal$Timeline$interruptLines, details.b8, startAt, scheduled, _List_Nil, lines);
		if (_v1.$ === 1) {
		...
		while (true) {
			if (!interrupts.b) {
				...
				var newEvents = A3(
					...
					timeline,
					A2($mdgriffith$elm_animator$Internal$Time$advanceBy, delay, timeline.b8),
					inter);
...
var $mdgriffith$elm_animator$Internal$Timeline$applyInterruptions = function (timeline) {
	...
	if (!_v0.b) {
		...
		return A2(
			...
			$elm$core$List$reverse(timeline.aK),
			_Utils_update(
				timeline,
				{aK: _List_Nil}));
	}
...
var $mdgriffith$elm_animator$Internal$Timeline$applyQueued = function (timeline) {
	...
	if (_v0.$ === 1) {
		...
		return _Utils_update(
			timeline,
			{
				bP: A3($mdgriffith$elm_animator$Internal$Timeline$enqueue, timeline, timeline.b8, queued),
				aN: $elm$core$Maybe$Nothing
			});
	}
};
...
var $mdgriffith$elm_animator$Internal$Timeline$clean = F2(
	function (runGC, details) {
		var running = function () {
			var _v1 = details.bP;
			var lines = _v1;
			return A2($mdgriffith$elm_animator$Internal$Timeline$linesAreActive, details.b8, lines);
		}();
		var events = function () {
			var _v0 = details.bP;
			var evs = _v0;
		...
		return _Utils_update(
			details,
			{
				bP: runGC ? A3($mdgriffith$elm_animator$Internal$Timeline$garbageCollectOldEvents, details.b8, _List_Nil, events) : details.bP,
				bb: running
			});
	});
...
var $mdgriffith$elm_animator$Internal$Timeline$updateWith = F3(
	function (withGC, possiblyNow, _v0) {
		...
		var now = A2(
			...
			timeline.b8);
		return _Utils_eq(timeline.bP, _List_Nil) ? A2(
			...
			$mdgriffith$elm_animator$Internal$Timeline$applyInterruptions(
				$mdgriffith$elm_animator$Internal$Timeline$applyQueued(
					_Utils_update(
						...
						{
							bP: function () {
								var firstOccurring = A3($mdgriffith$elm_animator$Internal$Timeline$Occurring, timeline.b_, now, now);
								return _List_fromArray(
									[
...
var $author$project$Main$BottomRight = 1;
var $author$project$Main$ControlReset = {$: 2};
var $author$project$Main$Down = 2;
var $author$project$Main$EndTurn = {$: 1};
var $author$project$Main$Left = 3;
var $author$project$Main$LeftTop = 0;
var $author$project$Main$Move = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$Right = 1;
var $author$project$Main$Up = 0;
var $author$project$Main$toControl = function (key) {
	_v0$14:
	while (true) {
		if (key.$ === 1) {
			switch (key.a) {
				...
				case 'l':
					return $elm$core$Maybe$Just(
						$author$project$Main$Move(
							{p: 1, q: 1}));
				case ' ':
					return $elm$core$Maybe$Just($author$project$Main$EndTurn);
				case 'r':
					return $elm$core$Maybe$Just($author$project$Main$ControlReset);
				default:
					break _v0$14;
			}
		}
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bs: oldTime, cm: request, cs: subs};
	});
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2(
					$elm$json$Json$Decode$map,
					A2($elm$core$Basics$composeR, $author$project$Main$toControl, $author$project$Main$ProcessControl),
...
var $author$project$Main$Partial = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$endPlayerTurn = function (model) {
	var currentAliveCells = $mdgriffith$elm_animator$Animator$current(model.b).C;
	return _Utils_Tuple2(
		model,
		A2(
			$elm$random$Random$generate,
			$author$project$Main$EnemyTurn,
			$author$project$Main$randomSelection(model.u)));
};
...
var $author$project$Main$addCell = F2(
	function (_v0, _v1) {
		var a = _v0.a;
		var b = _v0.b;
		var c = _v1.a;
...
var $author$project$Main$clampCell = F2(
	function (boardSize, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return _Utils_Tuple2(
			A3($elm$core$Basics$clamp, 0, boardSize - 1, x),
			A3($elm$core$Basics$clamp, 0, boardSize - 1, y));
	});
var $author$project$Main$pairSwap = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	return _Utils_Tuple2(b, a);
};
var $author$project$Main$sortSelection = function (_v0) {
	var _v1 = _v0.a;
	var x1 = _v1.a;
	var y1 = _v1.b;
	var _v2 = _v0.b;
	var x2 = _v2.a;
	var y2 = _v2.b;
	var startY = A2($elm$core$Basics$min, y1, y2);
	var startX = A2($elm$core$Basics$min, x1, x2);
	var endY = A2($elm$core$Basics$max, y1, y2);
	var endX = A2($elm$core$Basics$max, x1, x2);
	return _Utils_Tuple2(
		_Utils_Tuple2(startX, startY),
		_Utils_Tuple2(endX, endY));
};
var $author$project$Main$moveSelection = F3(
	function (boardSize, selection, _v0) {
		var selectionCorner = _v0.q;
		var direction = _v0.p;
		var delta = function () {
			switch (direction) {
				case 0:
		...
		var _v1 = function () {
			if (!selectionCorner) {
				return $author$project$Main$pairSwap(selection);
			} else {
				return selection;
			}
		}();
		...
		var cell = _v1.b;
		var newCell = A2(
			$author$project$Main$clampCell,
			boardSize,
			A2($author$project$Main$addCell, cell, delta));
		return $author$project$Main$sortSelection(
			_Utils_Tuple2(newCell, otherCell));
	});
var $author$project$Main$cellInSelection = F2(
	function (selection, _v0) {
		var cx = _v0.a;
		var cy = _v0.b;
		var _v1 = $author$project$Main$sortSelection(selection);
		var _v2 = _v1.a;
		var startX = _v2.a;
		var startY = _v2.b;
		var _v3 = _v1.b;
		var endX = _v3.a;
		var endY = _v3.b;
		return (_Utils_cmp(startX, cx) < 1) && ((_Utils_cmp(cx, endX) < 1) && ((_Utils_cmp(startY, cy) < 1) && (_Utils_cmp(cy, endY) < 1)));
	});
...
var $author$project$Main$entireSelection = _Utils_Tuple2(
	_Utils_Tuple2(0, 0),
	_Utils_Tuple2($author$project$Main$defaultBoardSize - 1, $author$project$Main$defaultBoardSize - 1));
...
var $author$project$Main$neighbours = F2(
	function (boardSize, cell) {
		var permutations = $elm$core$Set$fromList(
			A2(
				...
				A2(
					...
					_List_fromArray(
						[-1, 0, 1]))));
		var onGrid = $author$project$Main$cellInSelection($author$project$Main$entireSelection);
		var cells = A2(
			$elm$core$Set$filter,
			onGrid,
			A2(
				$elm$core$Set$map,
				function (c) {
					return _Utils_Tuple2(cell.a + c.a, cell.b + c.b);
				},
				permutations));
		return cells;
	});
var $author$project$Main$nextAliveCellsByPredicate = F3(
	function (predicate, boardSize, aliveCells) {
		var processCell = function (_v1) {
			var cell = _v1.a;
			var aliveNeighbours = _v1.b;
			var alive = A2($elm$core$Set$member, cell, aliveCells);
			if (predicate(cell)) {
				var _v0 = _Utils_Tuple2(alive, aliveNeighbours);
				_v0$3:
				while (true) {
					if (_v0.a) {
						switch (_v0.b) {
				...
				if (A2($elm$core$Set$member, cell, aliveCells)) {
					return $elm$core$Maybe$Just(cell);
				} else {
					return $elm$core$Maybe$Nothing;
				}
			...
			A2(
				...
				A2(
					...
					$elm$core$Tuple$mapSecond(
						function (s) {
							return 1 + $elm$core$List$length(s);
						}),
					$elm_community$list_extra$List$Extra$gatherEquals(
						A2(
							...
							A2(
								...
								$author$project$Main$neighbours(boardSize),
								$elm$core$Set$toList),
							$elm$core$Set$toList(aliveCells))))));
	});
var $elm$core$Basics$xor = _Basics_xor;
var $author$project$Main$nextAliveCellsBySelections = F2(
	function (selection1, selection2) {
		var predicate = function (cell) {
			return A2($author$project$Main$cellInSelection, selection1, cell) !== A2($author$project$Main$cellInSelection, selection2, cell);
		};
		return $author$project$Main$nextAliveCellsByPredicate(predicate);
	});
...
var $author$project$Main$unwrapInteractiveSelection = function (interactiveSelection) {
	if (!interactiveSelection.$) {
		var start = interactiveSelection.a.aQ;
		var lastHovered = interactiveSelection.a.a7;
		return _Utils_Tuple2(start, lastHovered);
	} else {
		var selection = interactiveSelection.a;
		return selection;
	}
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var currentState = $mdgriffith$elm_animator$Animator$current(model.b);
		var currentAliveCells = currentState.C;
		switch (msg.$) {
			case 0:
			...
			case 2:
				var time = msg.a;
				return _Utils_Tuple2(
					A3($mdgriffith$elm_animator$Animator$update, time, $author$project$Main$animator, model),
					$elm$core$Platform$Cmd$none);
			case 3:
				var aliveCells = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							b: A3(
								...
								{C: aliveCells, m: currentState.m, t: $author$project$Main$Idle},
								model.b)
						}),
					$elm$core$Platform$Cmd$none);
			case 9:
				var maybeControl = msg.a;
				if (!maybeControl.$) {
					switch (maybeControl.a.$) {
						case 0:
							var control = maybeControl.a.a;
							var playerSelection = $author$project$Main$Completed(
								A3(
									$author$project$Main$moveSelection,
									model.u,
									$author$project$Main$unwrapInteractiveSelection(currentState.m),
									control));
							return _Utils_Tuple2(
								_Utils_update(
									model,
						...
						case 1:
							...
							return $author$project$Main$endPlayerTurn(model);
						default:
							var _v3 = maybeControl.a;
							return $author$project$Main$init(0);
					}
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 5:
				var cell = msg.a;
				var playerSelection = $author$project$Main$Partial(
					{a7: cell, aQ: cell});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 6:
				...
				var playerSelection = function () {
					var _v4 = currentState.m;
					if (!_v4.$) {
						var start = _v4.a.aQ;
						return $author$project$Main$Partial(
							{a7: cell, aQ: start});
					} else {
			...
			case 7:
				var playerSelection = function () {
					var _v5 = currentState.m;
					if (!_v5.$) {
						var start = _v5.a.aQ;
						var lastHovered = _v5.a.a7;
						return $author$project$Main$Completed(
							_Utils_Tuple2(start, lastHovered));
					} else {
						return currentState.m;
					}
				}();
			...
			case 4:
				return $author$project$Main$endPlayerTurn(model);
			default:
				var enemySelection = msg.a;
				var newBoard = A4(
					$author$project$Main$nextAliveCellsBySelections,
					enemySelection,
					$author$project$Main$unwrapInteractiveSelection(currentState.m),
					model.u,
					currentAliveCells);
				var steps = _List_fromArray(
					[
						...
						_Utils_update(
							currentState,
							{
								t: $author$project$Main$ShowSelections(enemySelection)
							})),
						...
						_Utils_update(
							currentState,
							{C: newBoard, t: $author$project$Main$Idle}))
					]);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							b: A2($mdgriffith$elm_animator$Animator$queue, steps, model.b),
							aV: model.aV + 1
						}),
					$elm$core$Platform$Cmd$none);
		}
...
var $author$project$Main$EndPlayerTurn = {$: 4};
var $author$project$Main$EndSelection = {$: 7};
...
var $mdgriffith$elm_ui$Internal$Style$classes = {cG: 'a', be: 'atv', cI: 'ab', cJ: 'cx', cK: 'cy', cL: 'acb', cM: 'accx', cN: 'accy', cO: 'acr', bG: 'al', bH: 'ar', cP: 'at', bg: 'ah', bh: 'av', cS: 's', cY: 'bh', cZ: 'b', c$: 'w7', c1: 'bd', c2: 'bdt', aY: 'bn', c3: 'bs', aZ: 'cpe', c9: 'cp', da: 'cpx', db: 'cpy', S: 'c', a$: 'ctr', a0: 'cb', a1: 'ccx', T: 'ccy', aH: 'cl', a2: 'cr', dd: 'ct', de: 'cptr', df: 'ctxt', dp: 'fcs', bQ: 'focus-within', dq: 'fs', ds: 'g', bm: 'hbh', bn: 'hc', bV: 'he', bo: 'hf', bW: 'hfp', dv: 'hv', dx: 'ic', dz: 'fr', a5: 'lbl', dB: 'iml', dC: 'imlf', dD: 'imlp', dE: 'implw', dF: 'it', dH: 'i', b3: 'lnk', aw: 'nb', b7: 'notxt', dP: 'ol', dQ: 'or', ae: 'oq', dW: 'oh', cc: 'pg', cd: 'p', dX: 'ppe', d2: 'ui', G: 'r', d5: 'sb', d6: 'sbx', d7: 'sby', d8: 'sbt', ea: 'e', eb: 'cap', ec: 'sev', ei: 'sk', z: 't', en: 'tc', eo: 'w8', ep: 'w2', eq: 'w9', er: 'tj', bc: 'tja', es: 'tl', et: 'w3', eu: 'w5', ev: 'w4', ew: 'tr', ex: 'w6', ey: 'w1', ez: 'tun', eF: 'ts', ah: 'clr', eG: 'u', bC: 'wc', cA: 'we', bD: 'wf', cB: 'wfp', bE: 'wrp'};
...
var $mdgriffith$elm_ui$Element$Font$alignLeft = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.es);
var $mdgriffith$elm_ui$Element$Font$alignRight = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.ew);
var $mdgriffith$elm_ui$Internal$Flag$fontWeight = $mdgriffith$elm_ui$Internal$Flag$flag(13);
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.c$);
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.cS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.S);
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cc);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cd);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.cS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.G);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.J)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ed.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ed.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.G) + ('-' + ($elm$core$String$fromInt(pos.dc) + ('-' + ($elm$core$String$fromInt(pos.cz) + ('-' + $elm$core$String$fromInt(pos.bU)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.ah)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dp, $mdgriffith$elm_ui$Internal$Style$classes.ae)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.be, $mdgriffith$elm_ui$Internal$Style$classes.ae)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.G) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cS) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.G) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.a$) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {a_: closing, l: _List_Nil, X: _List_Nil, H: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								l: A2(
									$elm$core$List$cons,
									{a_: '\n}', l: _List_Nil, X: props, H: '@supports (' + (prop + (':' + (value + (') {' + parent.H))))},
									rendered.l)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.H + ('{' + (renderValues(rule.X) + (rule.a_ + '}')));
		}
	};
...
var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
	if (typeface.$ === 5) {
		var font = typeface.a;
		return A2($elm$core$List$any, $mdgriffith$elm_ui$Internal$Model$isSmallCaps, font.cv);
	} else {
		return false;
	}
};
	...
	if (typeface.$ === 5) {
		...
		return $elm$core$Maybe$Just(
			A2(
				$elm$core$String$join,
				', ',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$renderVariant, font.cv)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							...
							'-ms-grid-column-span: ' + ($elm$core$String$fromInt(position.cz) + ';')
						]));
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.G) + (' / ' + ($elm$core$String$fromInt(position.G + position.bU) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.dc) + (' / ' + ($elm$core$String$fromInt(position.dc + position.cz) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.G) + ('-' + ($elm$core$String$fromInt(position.dc) + ('-' + ($elm$core$String$fromInt(position.cz) + ('-' + $elm$core$String$fromInt(position.bU)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.eb + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.z + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.eb + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.z)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bU: height / size, ay: size, cx: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.c7, adjustment.cX, adjustment.dj, adjustment.dJ]);
	var lineHeight = 1.5;
	...
	return {
		c7: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.a$, $mdgriffith$elm_ui$Internal$Style$classes.T, $mdgriffith$elm_ui$Internal$Style$classes.cO])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.a$, $mdgriffith$elm_ui$Internal$Style$classes.T, $mdgriffith$elm_ui$Internal$Style$classes.cM])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.a$, $mdgriffith$elm_ui$Internal$Style$classes.cN])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.a$, $mdgriffith$elm_ui$Internal$Style$classes.cL])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cS + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.z + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bn)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cS + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.z + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bD + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bo)))));
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered._)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered._)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.cG]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.cZ]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.dQ]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.dP]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.dz]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.cY]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bG);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bH);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cJ);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.bh + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cI);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.bh + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cK);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.cS + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.S + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.cS + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.G + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.T + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.d8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b7)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Font$center = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.en);
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aH)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$dracula = {
	an: A3($mdgriffith$elm_ui$Element$rgb255, 40, 42, 54),
	aG: A3($mdgriffith$elm_ui$Element$rgb255, 98, 114, 164),
	bj: A3($mdgriffith$elm_ui$Element$rgb255, 68, 71, 90),
	dg: A3($mdgriffith$elm_ui$Element$rgb255, 139, 233, 253),
	av: A3($mdgriffith$elm_ui$Element$rgb255, 248, 248, 242),
	dr: A3($mdgriffith$elm_ui$Element$rgb255, 80, 250, 123),
	dV: A3($mdgriffith$elm_ui$Element$rgb255, 255, 184, 108),
	dY: A3($mdgriffith$elm_ui$Element$rgb255, 255, 121, 198),
	dZ: A3($mdgriffith$elm_ui$Element$rgb255, 189, 147, 249),
	d_: A3($mdgriffith$elm_ui$Element$rgb255, 255, 85, 85),
	eL: A3($mdgriffith$elm_ui$Element$rgb255, 241, 250, 140)
};
...
var $author$project$Main$playerScore = F2(
	function (boardSize, aliveCells) {
		return $elm$core$Set$size(
			A2(
				$elm$core$Set$filter,
				function (c) {
					return _Utils_cmp(c.a, (boardSize / 2) | 0) < 0;
				},
				aliveCells));
	});
var $author$project$Main$enemyScore = F2(
	function (boardSize, aliveCells) {
		return $elm$core$Set$size(aliveCells) - A2($author$project$Main$playerScore, boardSize, aliveCells);
	});
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.T)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$scaled = A2($mdgriffith$elm_ui$Element$modular, 16, 1.25);
var $author$project$Main$scaledInt = A2($elm$core$Basics$composeR, $author$project$Main$scaled, $elm$core$Basics$round);
var $mdgriffith$elm_ui$Element$htmlAttribute = $mdgriffith$elm_ui$Internal$Model$Attr;
var $author$project$Main$classNameToAttribute = A2($elm$core$Basics$composeR, $elm$html$Html$Attributes$class, $mdgriffith$elm_ui$Element$htmlAttribute);
var $author$project$Main$shallowPatternClass = $author$project$Main$classNameToAttribute('shallow-pattern');
...
var $author$project$Main$Enemy = 1;
var $author$project$Main$Player = 0;
var $author$project$Main$StartSelection = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$UpdateSelection = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Main$cellPatternClass = $author$project$Main$classNameToAttribute('cell-pattern');
...
var $mdgriffith$elm_animator$Internal$Interpolate$lerpColor = F7(
	function (prevEndTime, maybePrev, target, targetTime, now, maybeLookAhead, state) {
		...
		return A4(
			...
			A3($mdgriffith$elm_animator$Internal$Interpolate$average, one.d_, two.d_, progress),
			A3($mdgriffith$elm_animator$Internal$Interpolate$average, one.dr, two.dr, progress),
			A3($mdgriffith$elm_animator$Internal$Interpolate$average, one.bi, two.bi, progress),
			A3($mdgriffith$elm_animator$Internal$Interpolate$average, one.aj, two.aj, progress));
	});
var $mdgriffith$elm_animator$Internal$Interpolate$linearDefault = {cU: 0, cV: 0, dh: 0, di: 0, eJ: 0};
var $mdgriffith$elm_animator$Internal$Interpolate$coloring = {
	...
	bp: $mdgriffith$elm_animator$Internal$Interpolate$lerpColor,
	aQ: $elm$core$Basics$identity,
	bB: F5(
		function (lookup, target, targetTime, maybeLookAhead, state) {
			return lookup(
...
var $mdgriffith$elm_ui$Element$Border$dashed = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.c1);
var $mdgriffith$elm_ui$Element$Border$dotted = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.c2);
var $mdgriffith$elm_ui$Element$fromRgb = function (clr) {
	return A4($mdgriffith$elm_ui$Internal$Model$Rgba, clr.d_, clr.dr, clr.bi, clr.aj);
};
var $avh4$elm_color$Color$fromRgba = function (components) {
	return A4($avh4$elm_color$Color$RgbaSpace, components.d_, components.dr, components.bi, components.aj);
};
...
var $author$project$Main$leaf = function (attrs) {
...
var $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint = {cC: 0, cD: 0};
var $mdgriffith$elm_animator$Internal$Interpolate$createSpline = function (config) {
	var totalX = config.bN.cC - config.aQ.cC;
	var startVelScale = 1 / (config.aA.cC / totalX);
	var startVelocity = (!config.aJ.di) ? {cC: 0, cD: 0} : (((!(config.aA.cC - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.cC)) && (!(config.aA.cD - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.cD))) ? {cC: totalX * (config.aJ.di * 3), cD: 0} : {cC: (startVelScale * config.aA.cC) * (config.aJ.di * 3), cD: (startVelScale * config.aA.cD) * (config.aJ.di * 3)});
	var endVelScale = 1 / (config.as.cC / totalX);
	var endVelocity = (!config.aF.cV) ? {cC: 0, cD: 0} : (((!(config.as.cC - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.cC)) && (!(config.as.cD - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.cD))) ? {cC: totalX * (config.aF.cV * 3), cD: 0} : {cC: (endVelScale * config.as.cC) * (config.aF.cV * 3), cD: (endVelScale * config.as.cD) * (config.aF.cV * 3)});
	return A4(
		$mdgriffith$elm_animator$Internal$Interpolate$Spline,
		config.aQ,
		{cC: config.aQ.cC + ((1 / 3) * startVelocity.cC), cD: config.aQ.cD + ((1 / 3) * startVelocity.cD)},
		{cC: config.bN.cC + (((-1) / 3) * endVelocity.cC), cD: config.bN.cD + (((-1) / 3) * endVelocity.cD)},
		config.bN);
};
var $mdgriffith$elm_animator$Internal$Interpolate$findAtXOnSpline = F6(
	function (spline, desiredX, tolerance, jumpSize, t, depth) {
		...
		while (true) {
			...
			var point = function () {
				if (t <= 0.5) {
					var q3 = {cC: p3.cC + (t * (p4.cC - p3.cC)), cD: p3.cD + (t * (p4.cD - p3.cD))};
					var q2 = {cC: p2.cC + (t * (p3.cC - p2.cC)), cD: p2.cD + (t * (p3.cD - p2.cD))};
					var r2 = {cC: q2.cC + (t * (q3.cC - q2.cC)), cD: q2.cD + (t * (q3.cD - q2.cD))};
					var q1 = {cC: p1.cC + (t * (p2.cC - p1.cC)), cD: p1.cD + (t * (p2.cD - p1.cD))};
					var r1 = {cC: q1.cC + (t * (q2.cC - q1.cC)), cD: q1.cD + (t * (q2.cD - q1.cD))};
					return {cC: r1.cC + (t * (r2.cC - r1.cC)), cD: r1.cD + (t * (r2.cD - r1.cD))};
				} else {
					var q3 = {cC: p4.cC + ((1 - t) * (p3.cC - p4.cC)), cD: p4.cD + ((1 - t) * (p3.cD - p4.cD))};
					var q2 = {cC: p3.cC + ((1 - t) * (p2.cC - p3.cC)), cD: p3.cD + ((1 - t) * (p2.cD - p3.cD))};
					var r2 = {cC: q3.cC + ((1 - t) * (q2.cC - q3.cC)), cD: q3.cD + ((1 - t) * (q2.cD - q3.cD))};
					var q1 = {cC: p2.cC + ((1 - t) * (p1.cC - p2.cC)), cD: p2.cD + ((1 - t) * (p1.cD - p2.cD))};
					var r1 = {cC: q2.cC + ((1 - t) * (q1.cC - q2.cC)), cD: q2.cD + ((1 - t) * (q1.cD - q2.cD))};
					return {cC: r2.cC + ((1 - t) * (r1.cC - r2.cC)), cD: r2.cD + ((1 - t) * (r1.cD - r2.cD))};
				}
			}();
			if (depth === 10) {
				return {bu: point, bz: t};
			} else {
				if (($elm$core$Basics$abs(point.cC - desiredX) < 1) && ($elm$core$Basics$abs(point.cC - desiredX) >= 0)) {
					return {bu: point, bz: t};
				} else {
					if ((point.cC - desiredX) > 0) {
...
var $mdgriffith$elm_animator$Internal$Interpolate$firstDerivativeOnSpline = F2(
	function (_v0, proportion) {
		...
		return {
			cC: 3 * A3($mdgriffith$elm_animator$Internal$Interpolate$interpolateValue, wx1, wx2, proportion),
			cD: 3 * A3($mdgriffith$elm_animator$Internal$Interpolate$interpolateValue, wy1, wy2, proportion)
		};
	});
var $mdgriffith$elm_animator$Internal$Interpolate$guessTime = F2(
	function (now, _v0) {
		...
		var three = _v0.c;
		var four = _v0.d;
		return (!(four.cC - one.cC)) ? 0.5 : ((now - one.cC) / (four.cC - one.cC));
	});
		...
		if (maybeLookAhead.$ === 1) {
			...
			if (_v3.$ === 1) {
				...
				return A4(
					...
					$mdgriffith$elm_animator$Internal$Time$millis(lookAhead.cu));
			} else {
				var period = _v3.b;
				var toX = _v3.c;
				if (lookAhead.d$) {
		...
		var curve = $mdgriffith$elm_animator$Internal$Interpolate$createSpline(
			{
				...
				bN: {
					cC: targetTimeInMs,
					cD: $ianmackenzie$elm_units$Pixels$inPixels(targetPosition)
				},
				as: {cC: 1000, cD: targetVelocity},
				aQ: {
					cC: startTimeInMs,
					cD: $ianmackenzie$elm_units$Pixels$inPixels(state.O)
				},
				aA: {
					cC: 1000,
					cD: $ianmackenzie$elm_units$Pixels$inPixelsPerSecond(state.cw)
				}
			});
		var current = A6(
			...
			0);
		var firstDerivative = A2($mdgriffith$elm_animator$Internal$Interpolate$firstDerivativeOnSpline, curve, current.bz);
		return {
			O: $ianmackenzie$elm_units$Pixels$pixels(current.bu.cD),
			cw: $ianmackenzie$elm_units$Pixels$pixelsPerSecond(1000 * (firstDerivative.cD / firstDerivative.cC))
		};
	});
...
var $mdgriffith$elm_animator$Internal$Spring$step = F4(
	function (target, _v0, dtms, motion) {
		...
		var fdamper = ((-1) * damping) * motion.cw;
		var dt = dtms / 1000;
		var a = (fspring + fdamper) / mass;
		var newVelocity = motion.cw + (a * dt);
		var newPos = motion.O + (newVelocity * dt);
		return {O: newPos, cw: newVelocity};
	});
	...
	function (prevEndTime, _v0, target, targetTime, now, _v1, state) {
		...
		var _new = A4(
			...
			targetPos,
			{
				...
				cw: $ianmackenzie$elm_units$Pixels$inPixelsPerSecond(state.cw)
			});
		return {
			O: $ianmackenzie$elm_units$Pixels$pixels(_new.O),
			cw: $ianmackenzie$elm_units$Pixels$pixelsPerSecond(_new.cw)
		};
	});
	...
	function (prevEndTime, maybePrev, target, targetTime, now, maybeLookAhead, state) {
		...
		var nothingHappened = function () {
			if (!target.$) {
				...
				return _Utils_eq(
					x,
					$ianmackenzie$elm_units$Pixels$inPixels(state.O)) && (!$ianmackenzie$elm_units$Pixels$inPixelsPerSecond(state.cw));
			}
		}();
		if (nothingHappened) {
			return state;
...
var $mdgriffith$elm_animator$Internal$Interpolate$startMoving = function (movement) {
	return {
		...
		cw: $ianmackenzie$elm_units$Pixels$pixelsPerSecond(0)
	};
};
				...
				if (!period.$) {
					...
					return {
						O: $ianmackenzie$elm_units$Pixels$pixels(
							toX(progress)),
						cw: A3($mdgriffith$elm_animator$Internal$Interpolate$derivativeOfEasing, toX, periodDuration, progress)
					};
				} else {
					var n = period.a;
					var periodDuration = period.b;
...
var $mdgriffith$elm_animator$Internal$Interpolate$moving = {bf: $mdgriffith$elm_animator$Internal$Interpolate$getPersonality, bl: $mdgriffith$elm_animator$Internal$Interpolate$dwellPeriod, bp: $mdgriffith$elm_animator$Internal$Interpolate$lerp, aQ: $mdgriffith$elm_animator$Internal$Interpolate$startMoving, bB: $mdgriffith$elm_animator$Internal$Interpolate$visit};
...
var $mdgriffith$elm_animator$Internal$Interpolate$fillDefaults = F2(
	function (builtInDefault, specified) {
		if (!specified.$) {
			...
			return {
				cU: A2($mdgriffith$elm_animator$Internal$Interpolate$withDefault, builtInDefault.cU, partial.cU),
				cV: A2($mdgriffith$elm_animator$Internal$Interpolate$withDefault, builtInDefault.cV, partial.cV),
				...
				eJ: A2($mdgriffith$elm_animator$Internal$Interpolate$withDefault, builtInDefault.eJ, partial.eJ)
			};
		}
	});
...
var $mdgriffith$elm_animator$Animator$linear = F2(
	function (timeline, lookup) {
		return A2(
			...
			timeline,
			A2($elm$core$Basics$composeL, $mdgriffith$elm_animator$Internal$Interpolate$withLinearDefault, lookup)).O;
	});
var $author$project$Main$nextAliveCells = $author$project$Main$nextAliveCellsByPredicate(
...
var $mdgriffith$elm_animator$Internal$Timeline$previous = function (timeline) {
	...
	return A3(
		...
		$elm$core$Basics$identity,
		{
			...
			bp: $mdgriffith$elm_animator$Internal$Timeline$getPrev,
			aQ: function (_v2) {
				return details.b_;
			},
			bB: F5(
...
var $author$project$Main$viewBoard = function (model) {
	var viewSelection = F3(
		function (boardSize, player, selection) {
			var color = function () {
				if (!player) {
					return $author$project$Main$dracula.av;
				} else {
					return $author$project$Main$dracula.av;
				}
			}();
	...
	var previousState = $mdgriffith$elm_animator$Animator$previous(model.b);
	var currentState = $mdgriffith$elm_animator$Animator$current(model.b);
			...
			return _List_fromArray(
				[
					...
					A2(
						...
						A3(viewSelection, model.u, 1, sel)))
				]);
		};
		var _v5 = _Utils_Tuple2(previousState.t, currentState.t);
		if (_v5.a.$ === 1) {
	...
	var playerSelection = $author$project$Main$unwrapInteractiveSelection(currentState.m);
	var currentAliveCells = currentState.C;
	var nextStepAliveCells = A2($author$project$Main$nextAliveCells, model.u, currentAliveCells);
	var viewCell = function (cell) {
		var scale = A2(
			...
			function (state) {
				return $mdgriffith$elm_animator$Animator$at(
					A2($elm$core$Set$member, cell, state.C) ? 1 : 0);
			});
		var nextAlive = A2($elm$core$Set$member, cell, nextStepAliveCells);
		var mouseEnterEvent = function () {
			var _v3 = _Utils_Tuple2(currentState.m, currentState.t);
			if ((!_v3.a.$) && (!_v3.b.$)) {
				var _v4 = _v3.b;
		...
		var aliveColor = function () {
			...
			var inactiveColor = convertColor($author$project$Main$dracula.aG);
			var activeColor = convertColor($author$project$Main$dracula.av);
			...
			while (true) {
				if (_v0.a) {
					if (!_v0.b) {
						return _List_fromArray(
							[
								indicator($author$project$Main$dracula.an)
							]);
					} else {
						break _v0$2;
					}
				...
				[
					...
					_List_fromArray(
						[
							...
							{c4: 0, dI: 0, d1: 2, eC: 0}),
							$mdgriffith$elm_ui$Element$Border$color($author$project$Main$dracula.bj),
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$dracula.an),
				$mdgriffith$elm_ui$Element$Border$width(2),
				$mdgriffith$elm_ui$Element$Border$color($author$project$Main$dracula.bj),
				centerDelimiter
			]),
				...
				_List_fromArray(
					[
						...
						[
							...
							$mdgriffith$elm_ui$Element$padding(10),
							$mdgriffith$elm_ui$Element$behindContent(
							A3(viewSelection, model.u, 0, playerSelection))
						]),
						enemySelectionAttribute
					])),
			A2($elm_community$list_extra$List$Extra$initialize, model.u, viewRow)));
};
var $author$project$Main$layout = function (model) {
	var resetButton = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$dracula.an),
				$mdgriffith$elm_ui$Element$Border$color($author$project$Main$dracula.aG),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Main$dracula.aG),
				$mdgriffith$elm_ui$Element$Border$width(2),
				$mdgriffith$elm_ui$Element$Font$center,
				$mdgriffith$elm_ui$Element$Font$bold
			]),
		{
			b1: $mdgriffith$elm_ui$Element$text('Reset game'),
			ca: $elm$core$Maybe$Just($author$project$Main$Reset)
		});
	var nextTurnButton = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$padding(15),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$dracula.an),
				$mdgriffith$elm_ui$Element$Border$color($author$project$Main$dracula.av),
				$mdgriffith$elm_ui$Element$Border$width(2),
				$mdgriffith$elm_ui$Element$Font$center,
				$mdgriffith$elm_ui$Element$Font$bold
			]),
		{
			b1: $mdgriffith$elm_ui$Element$text('Next turn'),
			ca: $elm$core$Maybe$Just($author$project$Main$EndPlayerTurn)
		});
	var currentState = $mdgriffith$elm_animator$Animator$current(model.b);
	var mouseUpEvent = function () {
		var _v0 = currentState.t;
		if (!_v0.$) {
	...
	var root = $mdgriffith$elm_ui$Element$el(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$padding(
				$author$project$Main$scaledInt(1)),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$dracula.an),
				$author$project$Main$shallowPatternClass,
				$mdgriffith$elm_ui$Element$Font$family(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$typeface('Inter')
					])),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Main$dracula.av),
				$mdgriffith$elm_ui$Element$Events$onMouseUp(mouseUpEvent)
			]));
	var currentAliveCells = currentState.C;
	var score = function () {
		var textFromInt = A2($elm$core$Basics$composeL, $mdgriffith$elm_ui$Element$text, $elm$core$String$fromInt);
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					textFromInt(
						A2($author$project$Main$playerScore, model.u, currentAliveCells))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					textFromInt(
						A2($author$project$Main$enemyScore, model.u, currentAliveCells)))
				]));
	}();
	...
	return root(
		A2(
			...
			_List_fromArray(
				[score, board, nextTurnButton, resetButton])));
};
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{dp: $elm$core$Maybe$Nothing, dv: $elm$core$Maybe$Nothing, dK: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.ea]))),
		...
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			dU: _List_fromArray(
				[
					...
					{cW: $elm$core$Maybe$Nothing, c0: $elm$core$Maybe$Nothing, d9: $elm$core$Maybe$Nothing})
				])
		},
		_List_Nil,
		$author$project$Main$layout(model));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{dA: $author$project$Main$init, ek: $author$project$Main$subscriptions, eH: $author$project$Main$update, eI: $author$project$Main$view});
